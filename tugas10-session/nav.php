    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <span class="nav-link text-light">Halo, <?= htmlspecialchars($_SESSION['nama']) ?></span>
              </li>
              <li class="nav-item">
                <a class="nav-link text-warning" href="logout.php" onclick="return confirm('Yakin ingin logout?')">Logout</a>
              </li>
              <?php endif; ?>
            </ul>
      </div>
